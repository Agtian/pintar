...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Form Tambah Jenis Praktikan</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ url('dashboad/admin/master-jenis-praktikan') }}">Data Jenis
                                Praktikan</a></li>
                        <li class="breadcrumb-item active">Form Tambah Jenis Praktikan</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <section class="content">
        ...
        <div class="card card-dark">
            <div class="card-header border-transparent">
                <h3 class="card-title">Form Tambah Jenis Praktikan</h3>
            ...
            <form action="{{ url('dashboard/admin/master-jenis-praktikan') }}" method="POST">
                <div class="card-body">
                    @csrf
                    @method('POST')
