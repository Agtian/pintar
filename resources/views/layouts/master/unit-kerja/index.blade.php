    ...
    <section class="content">
        ...
        <div class="card card-dark">
            <div class="card-header border-transparent">
                <h3 class="card-title">Tabel Data Unit Kerja</h3>
            ...
            <div class="card-body p-0">
                <div class="table-responsive">
                    <table class="table table-bordered table-striped m-0">
                        ...
                        <tbody>
                            @forelse ($resultUnitKerja as $item)
                                <tr>
                                    <td align="center">{{ $loop->iteration + $resultUnitKerja->firstItem() - 1 }}</td>
                                    <td>{{ $item->unit_kerja }}</td>
                                    <td>{{ $item->created_at }}</td>
                                    <td align="center">
                                        <a href="{{ url('dashboard/admin/master-unit-kerja/' . base64_encode($item->id) . '/edit') }}"
                                            class="btn btn-sm btn-outline-warning"><i class="fas fa-edit"></i>
                                            Edit</a>
                                        <a href="{{ url('dashboard/admin/master-unit-kerja/' . base64_encode($item->id) . '/delete') }}"
