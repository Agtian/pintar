...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Form Ubah Unit Kerja</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ url('dashboad/admin/master-unit-kerja') }}">Data Unit
                                Kerja</a></li>
                        <li class="breadcrumb-item active">Form Ubah Unit Kerja</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <section class="content">
        ...
        <div class="card card-dark">
            ...
            <form action="{{ url('dashboard/admin/master-unit-kerja' . base64_encode($detail->id)) }}" method="POST">
                <div class="card-body">
                    @csrf
                    @method('PUT')
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control @error('satuan_kegiatan') is-invalid @enderror"
                                id="unit_kerja" name="unit_kerja" placeholder="Unit Kerja"
                                value="{{ $detail->unit_kerja }}">
                            @error('unit_kerja')
