...
@section('content')
    ...
    <section class="content">
        ...
        <div class="card card-dark">
            ...
            <form action="{{ url('dashboard/admin/master-tarif-pelatihan-pre-klinik/'.base64_encode($detail->id)) }}" method="POST">
                <div class="card-body">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <select name="status_tarif" id="status_tarif" class="form-control @error('status_tarif') is-invalid @enderror">
                                ...
                                <option value="2" {{ $detail->status_tarif == 2 ? 'selected' : '' }}>Tidak Aktif</option>
                            </select>
                            @error('status_tarif')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
