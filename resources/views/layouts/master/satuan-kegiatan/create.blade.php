...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Form Tambah Satuan Kegiatan</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ url('dashboad/admin/master-jenis-praktikan') }}">Data Satuan
                                Kegiatan</a></li>
                        <li class="breadcrumb-item active">Form Tambah Satuan Kegiatan</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <section class="content">
        ...
        <div class="card card-dark">
            <div class="card-header border-transparent">
                <h3 class="card-title">Form Tambah Satuan Kegiatan</h3>
            ...
            <form action="{{ url('dashboard/admin/master-satuan-kegiatan') }}" method="POST">
                <div class="card-body">
                    @csrf
                    @method('POST')
