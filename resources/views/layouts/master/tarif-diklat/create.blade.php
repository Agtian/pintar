...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Form Tambah Tarif Diklat</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ url('dashboad/admin/master-tarif-diklat') }}">Data Tarif
                                Diklat</a></li>
                        <li class="breadcrumb-item active">Form Tambah Tarif Diklat</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <section class="content">
        ...
        <div class="card card-dark">
            <div class="card-header border-transparent">
                <h3 class="card-title">Form Tambah Tarif Diklat</h3>
            ...
            <form action="{{ url('dashboard/admin/master-tarif-diklat') }}" method="POST">
                <div class="card-body">
                    @csrf
                    @method('POST')
                        ...
                        <div class="col-sm-9">
                            <select name="satuan_kegiatan_id" id="satuan_kegiatan_id"
                                ...
                                @foreach ($resultSatuanKegiatan as $item)
                                    <option value="{{ $item->id }}">{{ $item->satuan_kegiatan }}</option>
                                @endforeach
                            </select>
