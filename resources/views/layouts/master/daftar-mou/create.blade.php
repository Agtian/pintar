    ...
    <section class="content">
        ...
        <div class="card card-dark">
            <div class="card-header border-transparent">
                <h3 class="card-title">Form Tambah Daftar MOU</h3>
            ...
            <form action="{{ url('dashboard/admin/master-daftar-mou') }}" method="POST">
                <div class="card-body">
                    @csrf
                    @method('POST')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="date" class="form-control @error('tgl_mou') is-invalid @enderror"
                                id="tgl_mou" name="tgl_mou" value="{{ old('tgl_mou') }}">
                            @error('tgl_mou')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                            <input type="date" class="form-control @error('tgl_mulai_mou') is-invalid @enderror"
                                id="tgl_mulai_mou" name="tgl_mulai_mou" value="{{ old('tgl_mulai_mou') }}">
                            @error('tgl_mulai_mou')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="col-sm-3">
                            <input type="date" class="form-control @error('tgl_akhir_mou') is-invalid @enderror"
                                id="tgl_akhir_mou" name="tgl_akhir_mou" value="{{ old('tgl_akhir_mou') }}">
                            @error('tgl_akhir_mou')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
