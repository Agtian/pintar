    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form>
                    <div class="card-body">
                        <input type="hidden" name="peserta_diklat_id" wide:model="peserta_diklat_id">
            ...
            <div class="modal-footer justify-content-between">
                <button type="button" wire:click="closeModal" class="btn btn-dark"
                    data-dismiss="modal">Close</button>
                <button type="button" class="btn btn-primary" wire:click.prevent="updatePeserta()">Simpan</button>
            </div>
        </div>
    </div>
</div>
